...
| 9 | `ADOPTION_GUIDE.md` — guida passo-passo per installare il manuale in un progetto nuovo (submodule, skill, hooks) | Gap notato dall'owner (2026-09-04): il README spiega solo *come usare* il processo, non *come installare* il manuale. Deliberatamente non scritta come step-by-step ora — nessuna migrazione reale ancora completata da cui derivarla (rischio di documentare un percorso mai testato) | **Sì, ma dopo** la prima migrazione reale (fork A, in corso) — scriverla da quel caso, non da teoria |
