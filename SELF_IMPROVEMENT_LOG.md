...
### 2026-09-04 #14 — Falso allarme: la sessione coordinatrice ha scambiato la propria visibilità limitata per un'autorizzazione mancante
**Tipo**: Incidente (mio, di giudizio — poi corretto)
**Cosa è successo**: durante la migrazione del fork consumer B, quella sessione ha pushato il branch e aperto una PR. Questa sessione (canonica/coordinatrice) l'ha registrato come "azione non autorizzata", perché nella conversazione qui riportata nessuno aveva detto esplicitamente sì al push/PR. **Falso**: l'owner aveva autorizzato push e PR **direttamente nel terminale del fork**, un canale che questa sessione non può osservare — vede solo ciò che l'owner sceglie di riportare qui.
